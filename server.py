...
type 2 message is the welcome for the newly joined player containing info of current number of active (open connections) players and there pos. Format is BBB+Bii+Bii+Bii...... (3+9+9+9..... bytes)
'''
